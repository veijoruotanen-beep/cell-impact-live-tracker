...
COMEXT_DATASET = "DS-059322"
COMEXT_SOURCE_NOTE = "Scaffold only: COMEXT/CN8 bundle is prepared structurally, but live bundle logic is not yet locked to a verified CN8 basket."
...
def recompute_trade_index(data):
    ...
    cm["next_step_note"] = "Next step: replace or supplement tet00013 with a verified COMEXT/CN8 component basket for a closer Cell Impact proxy."
    cm["series_details"] = {
        "primary_dataset": EUROSTAT_DATASET,
        "comext_bundle_scaffold": {
            "dataset": COMEXT_DATASET,
            "status": "scaffold",
            "note": COMEXT_SOURCE_NOTE
        }
    }
...
def main():
    ...
    changes.append("COMEXT/CN8 scaffold metadata refreshed")
