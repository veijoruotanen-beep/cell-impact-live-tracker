...
def recompute_monthly_bundle(data):
    ...
    try:
        ...
        for yyyymm, archive_name in selected:
            ...
            row_iter = iter_rows(payload_path, archive_debug)
            cmap = map_columns(archive_debug.get("columns", []))
            exp_part, imp_part = process_archive_rows(row_iter, cmap, archive_debug)
